...
% Reading images from the home dir
J1 = imread("../../../T1.jpg");
J2 = imread("../../../T2.jpg");
...
thetas = -45:1:45;
NCC_vals = zeros(length(thetas), 1);
JE_vals = zeros(length(thetas), 1);
QMI_vals = zeros(length(thetas), 1);
...
for i = 1:length(thetas)
    ...
    NCC_vals(i) = NCC(J1, J4);
    JE_vals(i) = JE(J1, J4);
    QMI_vals(i) = QMI(J1, J4);

end

plot(thetas, NCC_vals);
...
op_theta = -29.0;
J5 = imrotate(J3, op_theta, "nearest", "crop");
